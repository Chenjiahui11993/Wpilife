...
export class ProductService {
    ...
    setProduct(id: string, name: string, price: number, ownerID: number, desc: string, img: string[], type: string) {
        this.productModel.push(new ProductModel(id, name, price, ownerID, desc, img, type));
    }
