...
var DemandComponent = /** @class */ (function () {
    ...
    DemandComponent = __decorate([
        core_1.Component({
            ...
            styles: [__webpack_require__("../../../../../src/app/component/demand/demand.component.css")]
        }),
        __metadata("design:paramtypes", [])
    ], DemandComponent);
...
var SellComponent = /** @class */ (function () {
    function SellComponent(productService, houseService, bookService, httpClient, authService) {
        this.productService = productService;
        this.houseService = houseService;
        this.bookService = bookService;
        this.httpClient = httpClient;
