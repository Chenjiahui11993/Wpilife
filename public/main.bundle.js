...
var HouseService = /** @class */ (function () {
    ...
    HouseService.prototype.setNewllHouse = function (address, desc, price, ownerinfo, contactInfo) {
        var _this = this;
        var options = { headers: new http_1.HttpHeaders({ 'Content-Type': 'application/json' }) };
        this.newHouse = new house_model_1.HouseModel(address, desc, price, ownerinfo, contactInfo);
...
var HomeComponentComponent = /** @class */ (function () {
    ...
    HomeComponentComponent.prototype.ngOnInit = function () {
        ...
        this.subscriptionHouse = this.houserService.getAllHouses()
            .subscribe(function (allhouse) { return _this.houseModel = allhouse; });
        ...
        this.subscriptionProducts = this.productService.getAllProduct()
            .subscribe(function (allProduct) { return _this.productModel = allProduct; });
    ...
    HomeComponentComponent.prototype.isHouse = function (i) {
        console.log('执行了');
        if (i.type === 'HOUSE') {
            return true;
        }
    };
    HomeComponentComponent.prototype.isBook = function (i) {
        console.log('执行了');
        if (i.type === 'BOOK') {
            return true;
        }
    };
    HomeComponentComponent.prototype.isProduct = function (i) {
        if (i.type === 'Product') {
            console.log('执行了');
            return true;
        }
...
var HouseDetailComponent = /** @class */ (function () {
    ...
    HouseDetailComponent.prototype.ngOnInit = function () {
        ...
        this.houseService.gethouse((this.id - 1))
            .then(function (house) { return _this.houseDetail = house; })
            .catch(function (e) {
            console.log(e);
        });
    };
...
var HouseModel = /** @class */ (function () {
    function HouseModel(Address, desc, price, ownerinfo, contactInfo) {
...
var ProductContactComponent = /** @class */ (function () {
    ...
    ProductContactComponent.prototype.ngOnInit = function () {
        ...
        this.productService.getProduct(this.id - 1)
            .then(function (product) { return _this.ProductDetail = product; })
            .catch(function (e) {
            console.log(e);
        });
...
module.exports = "<body>\r\n\t<div class=\"fh5co-loader\"></div>\r\n\t<div id=\"page\">\r\n\t\t<nav class=\"fh5co-nav\" role=\"navigation\">\r\n\t\t\t<div class=\"container\">\r\n\t\t\t\t<div class=\"row\">\r\n\t\t\t\t\t<div class=\"col-md-3 col-xs-2\">\r\n\t\t\t\t\t\t<div id=\"fh5co-logo\">\r\n\t\t\t\t\t\t\t<a routerLink=\"\">WPI.</a>\r\n\t\t\t\t\t\t</div>\r\n\t\t\t\t\t</div>\r\n\t\t\t\t\t<div class=\"col-md-6 col-xs-6 text-center menu-1\">\r\n\t\t\t\t\t\t<ul>\r\n\t\t\t\t\t\t\t<li class=\"has-dropdown active\">\r\n\t\t\t\t\t\t\t\t<a routerLink=\"/product-list\">Shop</a>\r\n\t\t\t\t\t\t\t\t<ul class=\"dropdown\">\r\n\t\t\t\t\t\t\t\t\t<li>\r\n\t\t\t\t\t\t\t\t\t\t<a href=\"single.html\">Single Shop</a>\r\n\t\t\t\t\t\t\t\t\t</li>\r\n\t\t\t\t\t\t\t\t</ul>\r\n\t\t\t\t\t\t\t</li>\r\n\t\t\t\t\t\t\t<li>\r\n\t\t\t\t\t\t\t\t<a href=\"about.html\">About</a>\r\n\t\t\t\t\t\t\t</li>\r\n\t\t\t\t\t\t\t<li class=\"has-dropdown\">\r\n\t\t\t\t\t\t\t\t<a href=\"services.html\">Services</a>\r\n\t\t\t\t\t\t\t\t<ul class=\"dropdown\">\r\n\t\t\t\t\t\t\t\t\t<li>\r\n\t\t\t\t\t\t\t\t\t\t<a href=\"#\">Web Design</a>\r\n\t\t\t\t\t\t\t\t\t</li>\r\n\t\t\t\t\t\t\t\t\t<li>\r\n\t\t\t\t\t\t\t\t\t\t<a href=\"#\">eCommerce</a>\r\n\t\t\t\t\t\t\t\t\t</li>\r\n\t\t\t\t\t\t\t\t\t<li>\r\n\t\t\t\t\t\t\t\t\t\t<a href=\"#\">Branding</a>\r\n\t\t\t\t\t\t\t\t\t</li>\r\n\t\t\t\t\t\t\t\t\t<li>\r\n\t\t\t\t\t\t\t\t\t\t<a href=\"#\">API</a>\r\n\t\t\t\t\t\t\t\t\t</li>\r\n\t\t\t\t\t\t\t\t</ul>\r\n\t\t\t\t\t\t\t</li>\r\n\t\t\t\t\t\t\t<li>\r\n\t\t\t\t\t\t\t\t<a href=\"contact.html\">Contact</a>\r\n\t\t\t\t\t\t\t</li>\r\n\t\t\t\t\t\t</ul>\r\n\t\t\t\t\t</div>\r\n\t\t\t\t\t<div class=\"col-md-3 col-xs-4 text-right hidden-xs menu-2\">\r\n\t\t\t\t\t\t<ul>\r\n\t\t\t\t\t\t\t<li class=\"search\">\r\n\t\t\t\t\t\t\t\t<div class=\"input-group\">\r\n\t\t\t\t\t\t\t\t\t<input type=\"text\" placeholder=\"Search..\">\r\n\t\t\t\t\t\t\t\t\t<span class=\"input-group-btn\">\r\n\t\t\t\t\t\t\t\t\t\t<button class=\"btn btn-primary\" type=\"button\">\r\n\t\t\t\t\t\t\t\t\t\t\t<i class=\"icon-search\"></i>\r\n\t\t\t\t\t\t\t\t\t\t</button>\r\n\t\t\t\t\t\t\t\t\t</span>\r\n\t\t\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t\t</li>\r\n\t\t\t\t\t\t\t<li class=\"shopping-cart\">\r\n\t\t\t\t\t\t\t\t<a href=\"#\" class=\"cart\">\r\n\t\t\t\t\t\t\t\t\t<span>\r\n\t\t\t\t\t\t\t\t\t\t<small>0</small>\r\n\t\t\t\t\t\t\t\t\t\t<i class=\"icon-shopping-cart\"></i>\r\n\t\t\t\t\t\t\t\t\t</span>\r\n\t\t\t\t\t\t\t\t</a>\r\n\t\t\t\t\t\t\t</li>\r\n\t\t\t\t\t\t</ul>\r\n\t\t\t\t\t</div>\r\n\t\t\t\t</div>\r\n\r\n\t\t\t</div>\r\n\t\t</nav>\r\n\r\n\t\t<header id=\"fh5co-header\" class=\"fh5co-cover fh5co-cover-sm\" role=\"banner\" style=\"background-image:url(../../../assets/img_bg_2.jpg);\">\r\n\t\t\t<div class=\"overlay\"></div>\r\n\t\t\t<div class=\"container\">\r\n\t\t\t\t<div class=\"row\">\r\n\t\t\t\t\t<div class=\"col-md-8 col-md-offset-2 text-center\">\r\n\t\t\t\t\t\t<div class=\"display-t\">\r\n\t\t\t\t\t\t\t<div class=\"display-tc animate-box\" data-animate-effect=\"fadeIn\">\r\n\t\t\t\t\t\t\t\t<h1>Product Details</h1>\r\n\t\t\t\t\t\t\t\t<h2>Free html5 templates Made</h2>\r\n\t\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t</div>\r\n\t\t\t\t\t</div>\r\n\t\t\t\t</div>\r\n\t\t\t</div>\r\n\t\t</header>\r\n\r\n\t\t<div id=\"fh5co-product\">\r\n\t\t\t<div class=\"container\">\r\n\t\t\t\t<div class=\"row\">\r\n\t\t\t\t\t<div class=\"col-md-10 col-md-offset-1\">\r\n\r\n\t\t\t\t\t\t<div class=\"carouselBox\">\r\n\t\t\t\t\t\t\t<div #test2 id=\"img1\">\r\n\t\t\t\t\t\t\t<ngx-carousel [inputs]=\"Config\">\r\n\t\t\t\t\t\t\t\t<ngx-item *ngFor=\"let product of ProductDetail.img\" class=\"bannerStyle \" NgxCarouselItem>\t\t\r\n\t\t\t\t\t\t\t\t\t<img [src]=\"product\" alt=\"user\" width=\"100%\" >\t\r\n\t\t\t\t\t\t\t\t</ngx-item>\r\n\t\t\t\t\t\t\t\t<i NgxCarouselPrev class=\"leftRs fa fa-arrow-left fa-3x\" aria-hidden=\"true\"></i>\r\n\t\t\t\t\t\t\t\t<i NgxCarouselNext class=\"rightRs fa fa-arrow-right fa-3x\" aria-hidden=\"true\"></i>\r\n\t\t\t\t\t\t\t</ngx-carousel>\r\n\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t\t<div class=\"clx\"></div>\r\n\t\t\t\t\t\t</div>\r\n\r\n\r\n\r\n\t\t\t\t\t\t<div class=\"row animate-box\">\r\n\t\t\t\t\t\t\t<div class=\"col-md-8 col-md-offset-2 text-center fh5co-heading\">\r\n\t\t\t\t\t\t\t\t<h2>{{ProductDetail.name}}</h2>\r\n\t\t\t\t\t\t\t\t<p>\r\n\t\t\t\t\t\t\t\t\t<a href=\"#\" class=\"btn btn-primary btn-outline btn-lg\">Post your Product to Sell</a>\r\n\t\t\t\t\t\t\t\t\t<a href=\"#\" class=\"btn btn-primary btn-outline btn-lg\">Compare</a>\r\n\t\t\t\t\t\t\t\t</p>\r\n\t\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t</div>\r\n\t\t\t\t\t</div>\r\n\t\t\t\t</div>\r\n\r\n\t\t\t\t<div class=\"row\">\r\n\t\t\t\t\t<div class=\"col-md-10 col-md-offset-1\">\r\n\t\t\t\t\t\t<ul class=\"nav nav-tabs\">\r\n\t\t\t\t\t\t\t<li class=\"list-group-item-heading\" role=\"presentation\" routerLinkActive=\"active\"  [routerLinkActiveOptions]=\"{exact: true}\">\r\n\t\t\t\t\t\t\t\t<a [routerLink]=\"[id, 'desc']\" >Product detail</a>\r\n\t\t\t\t\t\t\t</li>\r\n\t\t\t\t\t\t\t<li class=\"list-group-item-heading\"  role=\"presentation\" routerLinkActive=\"active\"  >\r\n\t\t\t\t\t\t\t\t<a [routerLink]=\"[id, 'contact']\">Contact info</a>\r\n\t\t\t\t\t\t\t</li>\t\r\n\t\t\t\t\t\t\t\t\t\t\t\r\n\t\t\t\t\t\t</ul>\r\n\t\t\t\t\t</div>\r\n\t\t\t\t</div>\r\n\t\t\t\t<!-- Tabs -->\r\n\t\t\t\t<router-outlet></router-outlet>\r\n\t\t\t\t<div class=\"col-md-10 col-md-offset-1\">\r\n\t\t\t\t\t<h3>Happy Buyers</h3>\r\n\t\t\t\t\t<div class=\"feed\">\r\n\t\t\t\t\t\t<div>\r\n\t\t\t\t\t\t\t<blockquote>\r\n\t\t\t\t\t\t\t\t<p>Paragraph placeat quis fugiat provident veritatis quia iure a debitis adipisci dignissimos consectetur magni quas\r\n\t\t\t\t\t\t\t\t\teius nobis reprehenderit soluta eligendi quo reiciendis fugit? Veritatis tenetur odio delectus quibusdam officiis\r\n\t\t\t\t\t\t\t\t\test.\r\n\t\t\t\t\t\t\t\t</p>\r\n\t\t\t\t\t\t\t</blockquote>\r\n\t\t\t\t\t\t\t<h3>&mdash; Louie Knight</h3>\r\n\t\t\t\t\t\t\t<span class=\"rate\">\r\n\t\t\t\t\t\t\t\t<i class=\"icon-star2\"></i>\r\n\t\t\t\t\t\t\t\t<i class=\"icon-star2\"></i>\r\n\t\t\t\t\t\t\t\t<i class=\"icon-star2\"></i>\r\n\t\t\t\t\t\t\t\t<i class=\"icon-star2\"></i>\r\n\t\t\t\t\t\t\t\t<i class=\"icon-star2\"></i>\r\n\t\t\t\t\t\t\t</span>\r\n\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t<div>\r\n\t\t\t\t\t\t\t<blockquote>\r\n\t\t\t\t\t\t\t\t<p>Paragraph placeat quis fugiat provident veritatis quia iure a debitis adipisci dignissimos consectetur magni quas\r\n\t\t\t\t\t\t\t\t\teius nobis reprehenderit soluta eligendi quo reiciendis fugit? Veritatis tenetur odio delectus quibusdam officiis\r\n\t\t\t\t\t\t\t\t\test.\r\n\t\t\t\t\t\t\t\t</p>\r\n\t\t\t\t\t\t\t</blockquote>\r\n\t\t\t\t\t\t\t<h3>&mdash; Joefrey Gwapo</h3>\r\n\t\t\t\t\t\t\t<span class=\"rate\">\r\n\t\t\t\t\t\t\t\t<i class=\"icon-star2\"></i>\r\n\t\t\t\t\t\t\t\t<i class=\"icon-star2\"></i>\r\n\t\t\t\t\t\t\t\t<i class=\"icon-star2\"></i>\r\n\t\t\t\t\t\t\t\t<i class=\"icon-star2\"></i>\r\n\t\t\t\t\t\t\t\t<i class=\"icon-star2\"></i>\r\n\t\t\t\t\t\t\t</span>\r\n\t\t\t\t\t\t</div>\r\n\t\t\t\t\t</div>\r\n\t\t\t\t</div>\r\n\t\t\t</div>\r\n\t\t</div>\r\n\t</div>\r\n\r\n\t<div id=\"fh5co-started\">\r\n\t\t<div class=\"container\">\r\n\t\t\t<div class=\"row animate-box\">\r\n\t\t\t\t<!-- UY BEGIN -->\r\n              <div id=\"uyan_frame\"></div>\r\n              <script type=\"text/javascript\" src=\"http://v2.uyan.cc/code/uyan.js?uid=2158295\"></script>\r\n               <!-- UY END -->\r\n\t\t\t</div>\r\n\t\t</div>\r\n\t</div>\r\n\r\n\t<footer id=\"fh5co-footer\" role=\"contentinfo\">\r\n\t\t<div class=\"container\">\r\n\t\t\t<div class=\"row row-pb-md\">\r\n\t\t\t\t<div class=\"col-md-4 fh5co-widget\">\r\n\t\t\t\t\t<h3>Shop.</h3>\r\n\t\t\t\t\t<p>Facilis ipsum reprehenderit nemo molestias. Aut cum mollitia reprehenderit. Eos cumque dicta adipisci architecto culpa\r\n\t\t\t\t\t\tamet.\r\n\t\t\t\t\t</p>\r\n\t\t\t\t</div>\r\n\t\t\t\t<div class=\"col-md-2 col-sm-4 col-xs-6 col-md-push-1\">\r\n\t\t\t\t\t<ul class=\"fh5co-footer-links\">\r\n\t\t\t\t\t\t<li>\r\n\t\t\t\t\t\t\t<a href=\"#\">About</a>\r\n\t\t\t\t\t\t</li>\r\n\t\t\t\t\t\t<li>\r\n\t\t\t\t\t\t\t<a href=\"#\">Help</a>\r\n\t\t\t\t\t\t</li>\r\n\t\t\t\t\t\t<li>\r\n\t\t\t\t\t\t\t<a href=\"#\">Contact</a>\r\n\t\t\t\t\t\t</li>\r\n\t\t\t\t\t\t<li>\r\n\t\t\t\t\t\t\t<a href=\"#\">Terms</a>\r\n\t\t\t\t\t\t</li>\r\n\t\t\t\t\t\t<li>\r\n\t\t\t\t\t\t\t<a href=\"#\">Meetups</a>\r\n\t\t\t\t\t\t</li>\r\n\t\t\t\t\t</ul>\r\n\t\t\t\t</div>\r\n\r\n\t\t\t\t<div class=\"col-md-2 col-sm-4 col-xs-6 col-md-push-1\">\r\n\t\t\t\t\t<ul class=\"fh5co-footer-links\">\r\n\t\t\t\t\t\t<li>\r\n\t\t\t\t\t\t\t<a href=\"#\">Shop</a>\r\n\t\t\t\t\t\t</li>\r\n\t\t\t\t\t\t<li>\r\n\t\t\t\t\t\t\t<a href=\"#\">Privacy</a>\r\n\t\t\t\t\t\t</li>\r\n\t\t\t\t\t\t<li>\r\n\t\t\t\t\t\t\t<a href=\"#\">Testimonials</a>\r\n\t\t\t\t\t\t</li>\r\n\t\t\t\t\t\t<li>\r\n\t\t\t\t\t\t\t<a href=\"#\">Handbook</a>\r\n\t\t\t\t\t\t</li>\r\n\t\t\t\t\t\t<li>\r\n\t\t\t\t\t\t\t<a href=\"#\">Held Desk</a>\r\n\t\t\t\t\t\t</li>\r\n\t\t\t\t\t</ul>\r\n\t\t\t\t</div>\r\n\r\n\t\t\t\t<div class=\"col-md-2 col-sm-4 col-xs-6 col-md-push-1\">\r\n\t\t\t\t\t<ul class=\"fh5co-footer-links\">\r\n\t\t\t\t\t\t<li>\r\n\t\t\t\t\t\t\t<a href=\"#\">Find Designers</a>\r\n\t\t\t\t\t\t</li>\r\n\t\t\t\t\t\t<li>\r\n\t\t\t\t\t\t\t<a href=\"#\">Find Developers</a>\r\n\t\t\t\t\t\t</li>\r\n\t\t\t\t\t\t<li>\r\n\t\t\t\t\t\t\t<a href=\"#\">Teams</a>\r\n\t\t\t\t\t\t</li>\r\n\t\t\t\t\t\t<li>\r\n\t\t\t\t\t\t\t<a href=\"#\">Advertise</a>\r\n\t\t\t\t\t\t</li>\r\n\t\t\t\t\t\t<li>\r\n\t\t\t\t\t\t\t<a href=\"#\">API</a>\r\n\t\t\t\t\t\t</li>\r\n\t\t\t\t\t</ul>\r\n\t\t\t\t</div>\r\n\t\t\t</div>\r\n\r\n\t\t\t<div class=\"row copyright\">\r\n\t\t\t\t<div class=\"col-md-12 text-center\">\r\n\t\t\t\t\t<p>\r\n\t\t\t\t\t\t<small class=\"block\">Copyright &copy; 2017.Company name All rights reserved.\r\n\t\t\t\t\t\t\t<a target=\"_blank\" href=\"http://guantaow.taobao.com/\">厚朴网络淘宝店</a>\r\n\t\t\t\t\t\t\t<a target=\"_blank\" href=\"http://www.moobnn.com\">网页模板</a>\r\n\t\t\t\t\t\t</small>\r\n\t\t\t\t\t</p>\r\n\t\t\t\t\t<p>\r\n\t\t\t\t\t\t<ul class=\"fh5co-social-icons\">\r\n\t\t\t\t\t\t\t<li>\r\n\t\t\t\t\t\t\t\t<a href=\"#\">\r\n\t\t\t\t\t\t\t\t\t<i class=\"icon-twitter\"></i>\r\n\t\t\t\t\t\t\t\t</a>\r\n\t\t\t\t\t\t\t</li>\r\n\t\t\t\t\t\t\t<li>\r\n\t\t\t\t\t\t\t\t<a href=\"#\">\r\n\t\t\t\t\t\t\t\t\t<i class=\"icon-facebook\"></i>\r\n\t\t\t\t\t\t\t\t</a>\r\n\t\t\t\t\t\t\t</li>\r\n\t\t\t\t\t\t\t<li>\r\n\t\t\t\t\t\t\t\t<a href=\"#\">\r\n\t\t\t\t\t\t\t\t\t<i class=\"icon-linkedin\"></i>\r\n\t\t\t\t\t\t\t\t</a>\r\n\t\t\t\t\t\t\t</li>\r\n\t\t\t\t\t\t\t<li>\r\n\t\t\t\t\t\t\t\t<a href=\"#\">\r\n\t\t\t\t\t\t\t\t\t<i class=\"icon-dribbble\"></i>\r\n\t\t\t\t\t\t\t\t</a>\r\n\t\t\t\t\t\t\t</li>\r\n\t\t\t\t\t\t</ul>\r\n\t\t\t\t</div>\r\n\t\t\t</div>\r\n\r\n\t\t</div>\r\n\t</footer>\r\n\t<div class=\"gototop js-top\">\r\n\t\t<a href=\"#\" class=\"js-gotop\">\r\n\t\t\t<i class=\"icon-arrow-up\"></i>\r\n\t\t</a>\r\n\t</div>\r\n</body>"
...
var SellComponent = /** @class */ (function () {
    function SellComponent(productService, houseService, bookService) {
        this.productService = productService;
        this.houseService = houseService;
        this.bookService = bookService;
        this.Departments = ['Computer Science', 'Electrical Engineering', 'ESL', 'Data Science', 'MSIT', 'Marketing', 'Others'];
    ...
    SellComponent = __decorate([
        ...
        __metadata("design:paramtypes", [product_service_1.ProductService, house_service_1.HouseService, book_service_1.BookService])
    ], SellComponent);
...
module.exports = "<div class=\"container\">\r\n\t<div class=\"row\">\r\n\t\t<div class=\"col-lg-12 \">\r\n\t\t\t<mat-form-field class=\"form-group\">\r\n\t\t\t\t<mat-select placeholder=\"Product Type\" \r\n\t\t\t\t[formControl]=\"selected\" \r\n\t\t\t\t[errorStateMatcher]=\"matcher\" \r\n\t\t\t\t[(ngModel)]=\"productType\"\r\n\t\t\t\t[(value)]=\"type\" \r\n\t\t\t\trequired>\r\n\t\t\t\t\t<mat-option *ngFor=\"let option of options\" [value]=\"option\">\r\n\t\t\t\t\t\t{{option}}\r\n\t\t\t\t\t</mat-option>\r\n\t\t\t\t</mat-select>\r\n\t\t\t\t<mat-error *ngIf=\"selected.hasError('required')\">You must make a selection</mat-error>\r\n\t\t\t\t<mat-hint *ngIf=\"!selected.touched\">Please select your product type</mat-hint>\r\n\t\t\t</mat-form-field>\r\n\t\t\t<form>\r\n\t\t\t\t<mat-form-field class=\"form-group\" [floatLabel]=\"'always'\">\r\n\t\t\t\t\t<mat-placeholder>\r\n\t\t\t\t\t\t<mat-icon>\r\n\t\t\t\t\t\t\tcreate\r\n\t\t\t\t\t\t</mat-icon>\r\n\t\t\t\t\t\t<i>Please Input your Product Name</i>\r\n\t\t\t\t\t</mat-placeholder>\r\n\t\t\t\t\t<input matInput [(ngModel)]=\"answer\" [formControl]=\"productNameError\" [errorStateMatcher]=\"matcher\" required>\r\n\t\t\t\t\t<mat-error *ngIf=\"productNameError.hasError('required')\">Product Name are Required</mat-error>\r\n\t\t\t\t</mat-form-field>\r\n\t\t\t</form>\r\n\t\t\t<form>\r\n\t\t\t\t<mat-form-field class=\"form-group\" [floatLabel]=\"'always'\">\r\n\t\t\t\t\t<mat-placeholder>\r\n\t\t\t\t\t\t<mat-icon>\r\n\t\t\t\t\t\t\tcreate\r\n\t\t\t\t\t\t</mat-icon>\r\n\t\t\t\t\t\t<i>Please Input your Product Price</i>\r\n\t\t\t\t\t</mat-placeholder>\r\n\t\t\t\t\t<input matInput [(ngModel)]=\"answer\" [formControl]=\"productPriceError\" [errorStateMatcher]=\"matcher\" required>\r\n\t\t\t\t\t<mat-error *ngIf=\"productPriceError.hasError('required')\">Product Price are Required</mat-error>\r\n\t\t\t\t</mat-form-field>\r\n\t\t\t</form>\r\n\t\t\t<form>\r\n\t\t\t\t<mat-form-field class=\"form-group\" [floatLabel]=\"'always'\">\r\n\t\t\t\t\t<mat-placeholder>\r\n\t\t\t\t\t\t<mat-icon>\r\n\t\t\t\t\t\t\tcreate\r\n\t\t\t\t\t\t</mat-icon>\r\n\t\t\t\t\t\t<i>Please Input your Contact Information</i>\r\n\t\t\t\t\t</mat-placeholder>\r\n\t\t\t\t\t<input matInput [(ngModel)]=\"answer\" [formControl]=\"productContactError\" [errorStateMatcher]=\"matcher\" required>\r\n\t\t\t\t\t<mat-error *ngIf=\"productContactError.hasError('required')\">Contact Information are Required</mat-error>\r\n\t\t\t\t</mat-form-field>\r\n\t\t\t</form>\r\n\t\t\t<form>\r\n\t\t\t\t<mat-form-field class=\"form-group\" [floatLabel]=\"'always'\">\r\n\t\t\t\t\t<mat-placeholder>\r\n\t\t\t\t\t\t<mat-icon>create</mat-icon>\r\n\t\t\t\t\t\t<i> A Good Description make your product easy to sell</i>\r\n\t\t\t\t\t</mat-placeholder>\r\n\t\t\t\t\t<textarea matInput matTextareaAutosize matAutosizeMinRows=\"2\" matAutosizeMaxRows=\"5\">\r\n\t\t\t\t\t\t\t </textarea>\r\n\t\t\t\t</mat-form-field>\r\n\t\t\t</form>\r\n\t\t\t<button (click)=\"show()\">show Error Message</button>\r\n\t\t\t<h3>\r\n\t\t\t\t{{answer}}\r\n\t\t\t\t{{type}}\r\n\t\t\t</h3>\r\n\t\t</div>\r\n\t</div>\r\n</div>"
...
var TestComponent = /** @class */ (function () {
    function TestComponent() {
        ...
        this.options = ['Household Item', 'Book', 'House', 'Others'];
        this.matcher = new MyErrorStateMatcher();
        this.productType = '';
    }
