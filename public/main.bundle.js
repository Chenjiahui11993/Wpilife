...
var BookService = /** @class */ (function () {
    ...
    BookService.prototype.setBook = function (name, price, ownerID, desc, contactInfo, img, department) {
        var _this = this;
        var options = {
        ...
        this.newBook = new book_model_1.BookModel(name, price, ownerID, desc, contactInfo, img, department, true);
...
var DemandService = /** @class */ (function () {
    ...
    DemandService.prototype.setDemandList = function (name, contactInfo, desc, ownerID) {
        var _this = this;
        var demandItem = new demand_model_1.DemandModel(name, contactInfo, desc, ownerID, true);
        var options = {
            headers: new http_1.HttpHeaders({ 'Content-Type': 'application/json' })
                .set('Authorization', 'Bearer ' + localStorage.getItem('access_token'))
        };
...
var HouseService = /** @class */ (function () {
    ...
    HouseService.prototype.setNewllHouse = function (address, price, ownerinfo, desc, contactInfo, img) {
        var _this = this;
        var options = {
            headers: new http_1.HttpHeaders({ 'Content-Type': 'application/json' })
                .set('Authorization', 'Bearer ' + localStorage.getItem('access_token'))
        };
        this.newHouse = new house_model_1.HouseModel(address, price, ownerinfo, desc, contactInfo, img, true);
...
var ProductService = /** @class */ (function () {
    ...
    ProductService.prototype.setProduct = function (name, price, ownerID, desc, contactInfo, img, type) {
        var _this = this;
        var options = {
            headers: new http_1.HttpHeaders({ 'Content-Type': 'application/json' })
                .set('Authorization', 'Bearer ' + localStorage.getItem('access_token'))
        ...
        type = true;
        this.newProduct = new product_model_1.ProductModel(name, price, ownerID, desc, contactInfo, img, type);
...
var DemandModel = /** @class */ (function () {
    function DemandModel(name, contactInfo, desc, ownerID, type) {
        this.name = name;
        this.contactInfo = contactInfo;
        this.description = desc;
        this.ownerID = ownerID;
        ...
        this.router.events.subscribe(function (ev) {
            if (ev instanceof router_1.NavigationStart) {
                if (ev.url !== _this.lastPoppedUrl) {
                    console.log('show ye bao cun' + _this.lastPoppedUrl);
...
module.exports = "<body>\n\t<div class=\"fh5co-loader\"></div>\n\t<div id=\"page\">\n\t\t<nav class=\"fh5co-nav\" role=\"navigation\">\n\t\t\t<div class=\"container\">\n\t\t\t\t<div class=\"row\">\n\t\t\t\t\t<div class=\"col-md-3 col-xs-2\">\n\t\t\t\t\t\t<div id=\"fh5co-logo\">\n\t\t\t\t\t\t\t<a routerLink=\"\">WPI.</a>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"col-md-6 col-xs-6 text-center menu-1\">\n\t\t\t\t\t\t<ul>\n\t\t\t\t\t\t\t<li>\n\t\t\t\t\t\t\t\t<a [routerLink]=\"''\">Home</a>\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t<li>\n\t\t\t\t\t\t\t\t\t<a [routerLink]=\"'/house-list'\">House</a>\n\t\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t<li>\n\t\t\t\t\t\t\t\t<a [routerLink]=\"'/survival-guide'\">New Students</a>\n\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t<li>\n\t\t\t\t\t\t\t\t<a [routerLink]=\"'/sell'\">Sell Your Product</a>\n\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t<li>\n\t\t\t\t\t\t\t\t<a href=\"contact.html\">Contact</a>\n\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t</ul>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</nav>\n\n\t\t<header id=\"fh5co-header\" class=\"fh5co-cover fh5co-cover-sm\" role=\"banner\" style=\"background-image:url(../../../assets/img_bg_2.jpg);\">\n\t\t\t<div class=\"overlay\"></div>\n\t\t\t<div class=\"container\">\n\t\t\t\t<div class=\"row\">\n\t\t\t\t\t<div class=\"col-md-8 col-md-offset-2 text-center\">\n\t\t\t\t\t\t<div class=\"display-t\">\n\t\t\t\t\t\t\t<div class=\"display-tc animate-box\" data-animate-effect=\"fadeIn\">\n\t\t\t\t\t\t\t\t<h1>House Details</h1>\n\t\t\t\t\t\t\t\t<h2>Our Goal is makeing your life much earier in WPI</h2>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</header>\n\n\t\t<div id=\"fh5co-product\">\n\t\t\t<div class=\"container\">\n\t\t\t\t<div class=\"row\">\n\t\t\t\t\t<div class=\"col-md-10 col-md-offset-1\">\n                      \n\t\t\t\t\t\t<div>\n\t\t\t\t\t\t\t<ngx-carousel [inputs]=\"Config\">\n\t\t\t\t\t\t\t\t<ngx-item *ngFor=\"let houseImg of imgUrl\" class=\"bannerStyle \" NgxCarouselItem>\n\t\t\t\t\t\t\t\t\t<img [src]=\"houseImg\" alt=\"house\" width=\"100%\" #test2 id=\"img1\">\n\t\t\t\t\t\t\t\t</ngx-item>\n\t\t\t\t\t\t\t\t<i NgxCarouselPrev class=\"leftRs fa fa-arrow-left fa-3x\" aria-hidden=\"true\"></i>\n\t\t\t\t\t\t\t\t<i NgxCarouselNext class=\"rightRs fa fa-arrow-right fa-3x\" aria-hidden=\"true\"></i>\n\t\t\t\t\t\t\t</ngx-carousel>\n\t\t\t\t\t\t</div>\t\t\t\t\t\n\t\t\t\t\t\t<div class=\"row animate-box\">\n\t\t\t\t\t\t\t<div class=\"col-md-8 col-md-offset-2 text-center fh5co-heading\">\n\t\t\t\t\t\t\t\t<h2>{{address}}</h2>\n\t\t\t\t\t\t\t\t<p>\n\t\t\t\t\t\t\t\t<a [routerLink]=\"'/sell'\" class=\"btn btn-primary btn-outline btn-lg\">Post your Product to Sell</a>\n\t\t\t\t\t\t\t\t</p>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\n\t\t\t\t<div class=\"row\">\n\t\t\t\t\t<div class=\"col-md-10 col-md-offset-1\">\n\t\t\t\t\t\t<ul class=\"nav nav-tabs\">\n\t\t\t\t\t\t\t<mat-tab-group>\n\t\t\t\t\t\t\t  <mat-tab label=\"Book detail\">\n\t\t\t\t\t\t\t\t<div class=\"col-md-8 \">\n\t\t\t\t\t\t\t\t\t<mat-list>\n\t\t\t\t\t\t\t\t\t  <mat-list-item>House Address: {{address}}</mat-list-item>\n\t\t\t\t\t\t\t\t\t  <mat-divider></mat-divider>\n\t\t\t\t\t\t\t\t\t  <mat-list-item>Rent fee(per month) : {{price}}$</mat-list-item>\n\t\t\t\t\t\t\t\t\t  <mat-divider></mat-divider>\n\t\t\t\t\t\t\t\t\t  <mat-list-item>House Description: {{desc}}</mat-list-item>\n\t\t\t\t\t\t\t\t\t</mat-list>   \n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t  </mat-tab>\n\t\t\t\t\t\t\t  <mat-tab label=\"Contact Info\">\n\t\t\t\t\t\t\t\t<div class=\"col-md-8\">\n\t\t\t\t\t\t\t\t  <mat-list>\n\t\t\t\t\t\t\t\t\t<mat-list-item>Contact information: {{contact}}</mat-list-item>\n\t\t\t\t\t\t\t\t\t<mat-divider></mat-divider>\n\t\t\t\t\t\t\t\t\t<mat-list-item>Owner information: {{ownerID}}</mat-list-item>\n\t\t\t\t\t\t\t\t\t<mat-divider></mat-divider>\n\t\t\t\t\t\t\t\t\t<mat-list-item>House Description: {{desc}}</mat-list-item>\n\t\t\t\t\t\t\t\t\t<mat-divider></mat-divider>\n\t\t\t\t\t\t\t\t  </mat-list>                    \n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t  </mat-tab>\n\t\t\t\t\t\t\t</mat-tab-group>\n\t\t\t\t\t\t  </ul>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\t\t\n\t\t\t</div>\n\t\t</div>\n\t</div>\n<app-footer></app-footer>\n</body>\n"
...
var HouseModel = /** @class */ (function () {
    function HouseModel(Address, price, ownerID, desc, contactInfo, img, type) {
...
var ProductModel = /** @class */ (function () {
    function ProductModel(name, price, ownerID, desc, contactInfo, img, type) {
        this.name = name;
        this.price = price;
        this.ownerID = ownerID;
        this.description = desc;
...
var TestComponent = /** @class */ (function () {
    ...
    TestComponent.prototype.show = function () {
        // let x = 2;
        // let y = 2;
        // (function () {
        // let x = 3;
    ...
    TestComponent.prototype.show2 = function () {
        console.log(this.x);
    };
